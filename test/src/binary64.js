...
describe('Binary64 numbers', function() {
    ...
    it('pack pi as 3.1415926535897931', function() {
        var buffer = [];
        ieee.pack(buffer, 0, 3.1415926535897931);
        assert.deepEqual(
            buffer, 
    ...
    it('pack 31.41592653589793', function() {
        var buffer = [];
        ieee.pack(buffer, 0, 31.41592653589793);
        assert.deepEqual(
            buffer,
    ...
    it('pack 314159265358979.3', function() {
        ...
        var buffer = [];
        ieee.pack(buffer, 0, 314159265358979.3);
        assert.deepEqual(
            buffer,
